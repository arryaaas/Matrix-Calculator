...
import kotlinx.android.synthetic.main.fragment_matrix_a.*
...
class MatrixAFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_matrix_a, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        gridViewMatrixA = view.findViewById(
            R.id.grid_view_matrix_a
        )
